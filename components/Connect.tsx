        ...
        <div className=" border-b pb-4 border-white w-full">
          ...
          <div className="mt-2 grid grid-cols-1">
            <select
              id="account"
              name="account"
              className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-[10px] pl-3 pr-8 text-sm text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
